# Debug script for Evopy Assistant on Windows (PowerShell)
...
Write-Host "Starting Evopy Debug Monitor..."
# Run debug monitor
& $PYTHON_CMD (Join-Path $SCRIPT_DIR "monitor.py") --script (Join-Path $SCRIPT_DIR "evo.py") $args
